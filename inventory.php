...
<main>
    ...
    <!--<div class="accordion" id="categoryitems">
        <div class="accordion-item border-0 mb-3">
            <h2 class="accordion-header">
                <button class="accordion-button d-flex align-items-center gap-2 p-0 pb-3" type="button" data-bs-toggle="collapse" data-bs-target="#categoryitem1" aria-expanded="true" aria-controls="categoryitem1">
                    <span class="fs-5 fw-bold">Category 1</span>
                    <i class="fa-solid fa-pen rename"></i>
                </button>
            </h2>
        ...
        <div class="accordion-item border-0">
            <h2 class="accordion-header">
                <button class="accordion-button d-flex align-items-center gap-2 p-0 pb-3" type="button" data-bs-toggle="collapse" data-bs-target="#categoryitem2" aria-expanded="true" aria-controls="categoryitem1">
                    <span class="fs-5 fw-bold">Category 1</span>
                    <i class="fa-solid fa-pen rename"></i>
                </button>
            </h2>
            <div id="categoryitem2" class="accordion-collapse collapse show" data-bs-parent="#categoryitems">
                <div class="accordion-body p-0">
                    <div class="inventory">
                        <div class="d-flex justify-content-between productdet">
                            <div class="d-flex gap-4 align-items-center proinf">
